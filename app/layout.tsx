...
export const metadata: Metadata = {
  title: "ExpenseAI - AI Expense Tracking via WhatsApp",
  description:
    "Track your daily expenses effortlessly through WhatsApp. AI categorization, real-time insights, and smart spending analytics in one place.",
  generator: "v0.app",
  icons: {
    icon: [
      {
